...
<div class="col-sm-10 col-12"> 
     <input type="text" class="form-control" id="pro_prix"  name="pro_prix"  value="<?php echo $row['pro_prix'];?>"> <br>
     </div>
     </div>   
    ...
    ?></select><br>
        ...
        <div class="col-sm-10 col-12"> 
        <textarea name="pro_description" id="pro_description" class="form-control" cols="30" rows="10" maxlength="1000"><?php echo $row['pro_description'];?></textarea><br>
        </div>
        </div>
