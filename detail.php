...
<h1 class="card-title">Etes vous sûr de vouloir supprimer <?php echo ''.$row['cat_nom'].' '.$row['pro_libelle'].' '.$row['pro_couleur'].'';?> de la base de données ?</h1>
   <a href="delete_form.php?pro_id=<?php echo $row['pro_id'];?>&del=1&confirm=1" class="btn btn-danger">Supprimer</a>    <a href="detail.php?pro_id=<?php echo $row['pro_id'];?>" class="btn btn-success">Annuler</a> 
   </div>
</div>
 <?php } ?>
  </article>
